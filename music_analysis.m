...
interpolation = 1;
write_fondamental = 1;
write_rounded_fondamental = 1;

display_all_peaks = 0;
display_fondamental = write_fondamental;
display_rounded_fondamental = write_rounded_fondamental;
...
% Projetection de la fondamentale sur le demi-tons
...
bias = mean(abs(rounded_fondamental(1,:)-fondamental(1,:)));
